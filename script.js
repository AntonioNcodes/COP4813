    ...
    form.addEventListener("submit", function (event) {
        ...
        if (birthValue === "") {
            ...
            if (isNaN(birth.getTime())) {
                ...
                showError("birthdateError", "Please enter a valid date.");
                valid = false;
        ...
        // Requires a street number and street name
        const addressPattern = /^\d+[A-Za-z]?\s+[A-Za-z0-9][A-Za-z0-9 .,'#-]*$/;

        if (address === "") {

            showError("addressError", "Please enter your street address.");
            valid = false;
        ...
        // If everything is valid, continue to confirmation page
        if (valid) {
            form.submit();
        } else {
